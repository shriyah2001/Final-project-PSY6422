...
fig1 <-
    ...
    labs(x = "Themes (of top 1000 anime titles)", y = "Count (of themes)") + # defining labels
...
fig2 <- 
    ...
    labs(x= "Demographics (of top 1000 anime titles)", y= "Count", title= "Bar graph of demographics") + # defining labels
