...
fig1 <-
    ...
    labs(x = "Themes (In the top 1000 titles)", y = "Count (Of the themes)") + # defining labels
...
fig2 <- 
    ...
    labs(x= "Demographics (Of top 1000 anime titles of 2023", y= "Count (of the demographics) ", title= "Bar graph of demographics") + # defining labels
